...
export default function AdminRecommendationsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300 flex flex-col" id="admin-recommendations-page-root">
      {/* Page Navigation Topbar */}
      <header className="sticky top-0 z-30 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800/80 px-6 py-4 flex items-center justify-between transition-all duration-300" id="admin-recommendations-page-header">
        <div className="flex items-center gap-4">
          <Button
            ...
            id="admin-recommendations-back-to-dashboard-btn"
          >
            Dashboard
          </Button>
        ...
        <div className="flex items-center gap-3">
          ...
          {user && (
            <button
              ...
              title="Sign Out"
              aria-label="Sign Out"
              id="admin-recommendations-header-logout-btn"
            >
      ...
      {/* Main Content Body */}
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 md:p-8" id="admin-recommendations-page-main">
