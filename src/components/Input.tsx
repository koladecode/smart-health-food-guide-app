      ...
      <div className="w-full flex flex-col gap-1.5" id={`${uniqueId}-wrapper`}>
        ...
        <div className="relative">
          ...
          <input
            ...
            } ${icon ? 'pl-11' : 'px-4'} py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-4 transition-all duration-200 ${className}`}
            {...props}
          />
        </div>
        {error && (
        ...
        <textarea
          ...
          className={`w-full rounded-xl bg-white dark:bg-gray-900 border ${
            error
              ? 'border-red-500 focus:ring-red-500/20 focus:border-red-500'
              : 'border-gray-200 dark:border-gray-800 focus:ring-emerald-500/20 focus:border-emerald-600'
          } px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-4 transition-all duration-200 min-h-[100px] ${className}`}
          {...props}
        />
        {error && (
          <p className="text-xs text-red-500 mt-0.5" id={`${uniqueId}-error`}>
